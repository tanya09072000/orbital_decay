function [TEMP, AL10N, AMMW, RHO] = cira(HEGEO, ALSA, DESA, ALSO, DESO, RJDAYS, GEO)
    % Константы и массивы
    AL10 = 2.3025851;
    ...
    F = 0.5 * (tanh(0.04 * (HEGEO - 350.0)) + 1.0);
    DLRGM = DLR20 * (1.0 - F);
...
% --- Расчёт плотности от 100 до 500 км ---
    ...
    FOFZ = (5.876e-7 * HEGEO^2.331 + 6.328e-2) * exp(-2.868e-3 * HEGEO);
    DLRSA = FOFZ * GOFT;
    ...
    if HEGEO > 460.0
        ...
        DLRSL = 0.014 * (HEGEO - 90.0) * exp(-1.3e-3 * (HEGEO - 90)^2) ...
